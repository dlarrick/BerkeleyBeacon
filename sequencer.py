...
class ColorSequencer(IntervalTimer):
    ...
    def __init__(self, interval, init_sequence=None, debug=False):
        self._interval = interval
        IntervalTimer.__init__(self, self._interval, ColorSequencer.sequencer)
