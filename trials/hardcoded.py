...
def hardcoded():
    # Red, off, blue, off
    resource_red = { 'which':beacon, 'data': { 'state': {'on':True, 'xy':colors_xy[1], 'sat':255, 'bri':255}}}
    resource_blue = { 'which':beacon, 'data': { 'state': {'on':True, 'xy':colors_xy[0], 'sat':255, 'bri':255}}}
